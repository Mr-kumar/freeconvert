...
Revision ID: 002
Revises: 001
Create Date: 2026-02-10 14:07:00.000000
...
def upgrade() -> None:
    ...
    # Update existing records to have default file_count
    op.execute("UPDATE jobs SET file_count = 1 WHERE file_count IS NULL")
