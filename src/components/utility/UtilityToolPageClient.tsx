...
import { HtmlTool } from "@/components/utility/tools/html-tools";
import {
  PasswordGenerator,
...
> = {
  ...
  "html-to-pdf": HtmlTool,
  "html-viewer": HtmlTool,
  "html-formatter": HtmlTool,
  "html-minifier": HtmlTool,
  "html-validator": HtmlTool,
  "html-to-markdown": HtmlTool,
  "markdown-to-html": HtmlTool,
  "html-to-text": HtmlTool,
  "html-entities-encoder-decoder": HtmlTool,
  "html-table-generator": HtmlTool,
  "html-to-image": HtmlTool,
  "responsive-html-preview": HtmlTool,
  "iframe-generator": HtmlTool,
  "meta-tag-generator": HtmlTool,
  "css-js-formatter-minifier": HtmlTool,
